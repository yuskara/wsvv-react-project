...
const DashBoard = () =>{
    ...
    // const [switchLight, setSwithchLight] = useState(false);
...
/*TOGGLE MOBILE MENU*/
// toggleMobileMenu.addEventListener("click", function () { console.log("toggleMobileMenu");
...
return(
      ...
      <ul className="admin-menu">
        ...
        <li>
          <div className="switch">
            <input type="checkbox" id="mode" checked></input>
            <label for="mode">
              <span></span>
              <span>Dark</span>
            </label>
  ...
  <section className="page-content">
    <section className="search-and-user">
      <form>
        <input type="search" placeholder="Search Pages..."></input>
    ...
    <section className="grid">
      <article>Powerline Backhaul: The Powerline Deco P9 adds a third lane for data to travel through,
         similar to a Tri-band mesh router, to create stronger connections between Deco units and increase
          the home network's overall performance, eliminating signal interference from thick walls and other objects.
    Intelligent WiFi Mesh Network: Unite your home under a single WiFi name and password while enjoying a seamless connection as you walk from room to room.</article>
      <article>Parental Controls: Manage, limit and monitor internet use with parental controls that let you customize WiFi access for every person and device in your home.</article>
      <article>Easy Setup and Management: The Deco app helps you set up your home network in minutes with clear visual guidance and keeps you in control even when you aren't home.</article>
      <article>Whole Home WiFi Coverage: Cover up to 6, 000 square feet with seamless, high speed WiFi that eliminates dead zones and buffering. Better than traditional wifi booster.</article>
      <article>Works With Alexa: Pair with Alexa to share your guest wifi password, add devices and more using just your voice.</article>
      <article>Universally Compatible: Deco works with any internet service provider (ISP) and modem.</article>
      <article></article>
      <article></article>
    </section>
    <footer className="page-footer">
      <span>made by Eksi-Nous Web Developer Team </span>
      <a href="https://www.amnick.com/" target="_blank">
        <img width="24" height="24" src="https://assets.codepen.io/162656/george-martsoukos-small-logo.svg" alt="Eksi-Nous logo"></img>
      </a>
    </footer>
  </section>
